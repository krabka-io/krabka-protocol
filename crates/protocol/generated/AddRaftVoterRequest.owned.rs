...
use crate::{
    ...
    primitives::{
        fixed::{get_bool, get_i32, get_u16, put_bool, put_i32, put_u16},
        string_bytes::{
...
impl crate::ProtocolRequest for AddRaftVoterRequest {
    ...
    type Response = super::add_raft_voter_response::AddRaftVoterResponse;
}
