...
pub struct ReadShareGroupStateSummaryRequest<'a> {
    pub group_id: &'a str,
...
impl ReadShareGroupStateSummaryRequest<'_> {
    ...
    ) -> crate::owned::read_share_group_state_summary_request::ReadShareGroupStateSummaryRequest
    {
        crate::owned::read_share_group_state_summary_request::ReadShareGroupStateSummaryRequest {
            ...
            topics: (self.topics)
                .iter()
                .map(ReadStateSummaryData::to_owned)
                .collect(),
            unknown_tagged_fields: self.unknown_tagged_fields.clone(),
        }
    }
}
impl Encode for ReadShareGroupStateSummaryRequest<'_> {
    ...
    fn decode_borrow(buf: &mut &'de [u8], version: i16) -> Result<Self, ProtocolError> {
        ...
        if version >= 0 {
            out.topics = {
                ...
                for _ in 0..n {
                    v.push(ReadStateSummaryData::decode_borrow(buf, version)?);
                }
                v
            };
        }
