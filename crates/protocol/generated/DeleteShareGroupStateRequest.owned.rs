...
impl Encode for DeleteShareGroupStateRequest {
    ...
    fn decode<B: Buf>(buf: &mut B, version: i16) -> Result<Self, ProtocolError> {
        ...
        if version >= 0 {
            out.topics = {
                ...
                for _ in 0..n {
                    v.push(DeleteStateData::decode(buf, version)?);
                }
                v
            };
        }
...
impl DeleteShareGroupStateRequest {
    ...
    pub fn populated(version: i16) -> Self {
        ...
        if version >= 0 {
            m.topics = vec![DeleteStateData::populated(version)];
        }
        m
    }
}
...
impl crate::ProtocolRequest for DeleteShareGroupStateRequest {
    ...
    type Response = super::delete_share_group_state_response::DeleteShareGroupStateResponse;
}
