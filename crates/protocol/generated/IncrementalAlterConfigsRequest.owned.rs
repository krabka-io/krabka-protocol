...
use crate::{
    ...
    primitives::{
        fixed::{get_bool, get_i8, put_bool, put_i8},
        string_bytes::{
...
impl crate::ProtocolRequest for IncrementalAlterConfigsRequest {
    ...
    type Response = super::incremental_alter_configs_response::IncrementalAlterConfigsResponse;
}
