...
impl Encode for ReadShareGroupStateSummaryRequest {
    ...
    fn decode<B: Buf>(buf: &mut B, version: i16) -> Result<Self, ProtocolError> {
        ...
        if version >= 0 {
            out.topics = {
                ...
                for _ in 0..n {
                    v.push(ReadStateSummaryData::decode(buf, version)?);
                }
                v
            };
        }
...
impl ReadShareGroupStateSummaryRequest {
    ...
    pub fn populated(version: i16) -> Self {
        ...
        if version >= 0 {
            m.topics = vec![ReadStateSummaryData::populated(version)];
        }
        m
    }
}
...
impl Encode for ReadStateSummaryData {
    fn encode<B: BufMut>(&self, buf: &mut B, version: i16) -> Result<(), ProtocolError> {
        let flex = version >= 0;
        if version >= 0 {
...
impl crate::ProtocolRequest for ReadShareGroupStateSummaryRequest {
    ...
    type Response =
        super::read_share_group_state_summary_response::ReadShareGroupStateSummaryResponse;
}
