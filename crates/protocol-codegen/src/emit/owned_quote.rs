...
use crate::{
    emit::{
        ...
        protocol_request, tagged_fixture,
    },
...
pub fn emit(spec: &MessageSpec, schemas_version: &str) -> Result<EmittedMessage, EmitError> {
    ...
    let tf = tagged_fixture::emit_tagged_fixture(spec, &res_map);
