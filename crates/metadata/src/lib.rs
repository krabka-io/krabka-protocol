...
//!
//! `krabka-metadata` provides [`MetadataRecord`], the versioned union
...
//! machine in `krabka-raft` calls that method. Everywhere else reads it
...
//!
//! ```rust
//! use krabka_metadata::canonicalize_entity;
//!
